package org.sf_ref.rdf.io;

import org.sf_ref.db.rdf.syntax.RDFSyntaxFactoryImpl;
...
import org.sf_ref.rdf.util.ModelConsumer;
...
public class SerializableModel implements Model, Serializable {
  ...
  static RDFSyntaxFactory defaultLookup = new RDFSyntaxFactoryImpl();
  static ModelFactory defaultModelFactory = new RDFFactoryImpl();

  static String defaultTargetFormat = RDFSyntaxFactoryImpl.TripleXML_20010107;
