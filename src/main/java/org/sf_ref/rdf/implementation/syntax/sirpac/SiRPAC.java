 ...
 *
 * ==========================================================================
 * WARNING: THIS IS NOT THE ORIGINAL sf_ref RELEASE OF SIRPAC!
 *
 ...
 */
package org.sf_ref.rdf.implementation.syntax.sirpac;

import org.sf_ref.db.rdf.syntax.generic.DumpConsumer;
import org.sf_ref.db.rdf.vocabulary.order_20000527.RDFX;
import org.sf_ref.db.xml.util.ErrorStore;
import org.sf_ref.db.xml.util.GenericParser;
...
import org.sf_ref.rdf.util.RDFReader;
import org.sf_ref.rdf.vocabulary.rdf_schema_19990303.RDFS;
import org.sf_ref.rdf.vocabulary.rdf_syntax_19990222.RDF;
import org.sf_ref.rdf.model.*;
import org.sf_ref.db.xml.util.*;
...
public class SiRPAC implements EntityResolver, DTDHandler, DocumentHandler,
  ...
  private org.sf_ref.rdf.implementation.syntax.sirpac.Element m_root = null;
...
// 			   "Override for IBM xml4j is: -Dorg.xml.sax.parser=com.ibm.xml.parser.SAXDriver");
  ...
  public boolean parseLiteral() {
    if (!m_elementStack.empty()) {
      for (int x = m_elementStack.size()-1; x >= 0; x--) {
        org.sf_ref.rdf.implementation.syntax.sirpac.Element e = (org.sf_ref.rdf.implementation.syntax.sirpac.Element)m_elementStack.elementAt(x);
  ...
  */
  ...
  private org.sf_ref.rdf.implementation.syntax.sirpac.Element scanModeElement = null;
  // END SM
  ...
  */
  ...
  public void startElement (String name, AttributeList al) throws SAXException {
    ...
    org.sf_ref.rdf.implementation.syntax.sirpac.Element newElement = null;
    int i = name.indexOf (':');
    ...
    if (parseLiteral) {
      if (sPrefix2 == null) {
        ...
        newElement = new org.sf_ref.rdf.implementation.syntax.sirpac.Element("gen:", sElementName,
                                  newAL);
        ...
        if (sAttributeNamespace != null)
          newAL.addAttribute ("xmlns:", sPrefix2, null,
                              "CDATA",
                              sAttributeNamespace);
        newElement = new org.sf_ref.rdf.implementation.syntax.sirpac.Element(sPrefix2 + ":", sElementName,
                                  newAL);
      }
    } else {
      newElement = new org.sf_ref.rdf.implementation.syntax.sirpac.Element(sNamespace, sElementName,
                                newAL);
    ...
    if(scanMode != smSKIPPING) {
      ...
      if (sLiteralValue != null && !sLiteralValue.equals (RDFMS_parseType_Resource)) {
        ...
        if (!m_elementStack.empty()) {
          org.sf_ref.rdf.implementation.syntax.sirpac.Element e = (org.sf_ref.rdf.implementation.syntax.sirpac.Element)m_elementStack.peek ();
    ...
    if (sLiteralValue != null && sLiteralValue.equals (RDFMS_parseType_Resource)) {
       ...
       */
      org.sf_ref.rdf.implementation.syntax.sirpac.Element desc = new org.sf_ref.rdf.implementation.syntax.sirpac.Element(RDFMS_Description, new AttributeListImpl());
  ...
  */
  ...
  public void endElement (String name) throws SAXException {
    ...
    try {
      ...
      m_root = (org.sf_ref.rdf.implementation.syntax.sirpac.Element)m_elementStack.pop ();
	...
	return;
      ...
      if (bParseLiteral) {
	org.sf_ref.rdf.implementation.syntax.sirpac.Element pe = (org.sf_ref.rdf.implementation.syntax.sirpac.Element)m_parseElementStack.peek ();
	if (pe != m_root) {
	...
	if (!m_elementStack.empty()) {
	  ...
	  if (m_elementStack.peek() == pe) {
	    org.sf_ref.rdf.implementation.syntax.sirpac.Element e = (org.sf_ref.rdf.implementation.syntax.sirpac.Element)m_elementStack.pop ();
	    m_parseElementStack.pop();
	    m_parseTypeStack.pop ();
	  }
	}
  ...
  void preProcessXML(org.sf_ref.rdf.implementation.syntax.sirpac.Element root) throws SAXException, ModelException {
   ...
   */
  public org.sf_ref.rdf.implementation.syntax.sirpac.Element root () {
    return m_root;
  }
  ...
  public void characters (char ch[], int start, int length)
    ...
    Data dataNode = null;
    Enumeration en = e.children();
    while (en.hasMoreElements()) {
      org.sf_ref.rdf.implementation.syntax.sirpac.Element e2 = (org.sf_ref.rdf.implementation.syntax.sirpac.Element)en.nextElement();
  ...
  */
   ...
   * @exception SAXException Passed on since we don't handle it.
   */
  public void processXML (org.sf_ref.rdf.implementation.syntax.sirpac.Element ele) throws SAXException, ModelException {
   ...
   * @exception SAXException Passed on since we don't handle it.
   */
  public void processRDF (org.sf_ref.rdf.implementation.syntax.sirpac.Element rdf) throws SAXException, ModelException {
    ...
    //  }
    while (e.hasMoreElements()) {
      org.sf_ref.rdf.implementation.syntax.sirpac.Element ele = (org.sf_ref.rdf.implementation.syntax.sirpac.Element)e.nextElement();
   ...
   * @exception SAXException Passed on since we don't handle it.
   */
  public String processTypedNode (org.sf_ref.rdf.implementation.syntax.sirpac.Element typedNode) throws SAXException, ModelException {
    String sID              = typedNode.ID();
    String sBagID           = typedNode.bagID();
    String sAbout           = typedNode.about();

    org.sf_ref.rdf.implementation.syntax.sirpac.Element target = typedNode.target();
    ...
    while (e.hasMoreElements()) {
      ...
      if (!RDFMS.equals(sAttribute.getNamespace()) &&
        ...
        if (sValue.length() > 0) {
          org.sf_ref.rdf.implementation.syntax.sirpac.Element newPredicate = new org.sf_ref.rdf.implementation.syntax.sirpac.Element(/*sAttribute.getName(),*/ sAttribute.getNamespace(), sAttribute.getLocalName(),
    ...
    if (sAboutEach != null &&
      ...
      org.sf_ref.rdf.implementation.syntax.sirpac.Element newPredicate = new org.sf_ref.rdf.implementation.syntax.sirpac.Element(RDFMS, "type",
                                          new AttributeListImpl());
   ...
   * @exception SAXException Passed on since we don't handle it.
   */
  public String processDescription (org.sf_ref.rdf.implementation.syntax.sirpac.Element description,
                                    boolean inPredicate,
                                    boolean reify,
    ...
    org.sf_ref.rdf.implementation.syntax.sirpac.Element target = description.target();
      ...
      if (isContainer(target)) {
        ...
        while (e.hasMoreElements()) {
          ...
          if (isListItem (ele)) {
             ...
             */
            if (sResource != null) {
              org.sf_ref.rdf.implementation.syntax.sirpac.Element newDescription = null;
              // 1.13
              //                            if (sResource != null) {
              ...
              //
              //                            }
              newDescription = new org.sf_ref.rdf.implementation.syntax.sirpac.Element(RDFMS_Description,
                                            new AttributeListImpl ());
              newDescription.about (sResource);

              Enumeration e2 = description.children();
              while (e2.hasMoreElements()) {
                org.sf_ref.rdf.implementation.syntax.sirpac.Element ele2 = (org.sf_ref.rdf.implementation.syntax.sirpac.Element)e2.nextElement ();
              ...
              while (e2.hasMoreElements()) {
                ...
                org.sf_ref.rdf.implementation.syntax.sirpac.Element newNode = new org.sf_ref.rdf.implementation.syntax.sirpac.Element(RDFMS_Description,
                                               new AttributeListImpl());
                Enumeration e3 = description.children();
                while (e3.hasMoreElements()) {
                  org.sf_ref.rdf.implementation.syntax.sirpac.Element ele3 = (org.sf_ref.rdf.implementation.syntax.sirpac.Element)e3.nextElement ();
    ...
    if (sAboutEachPrefix != null) {
      if (hasTarget) {
        ...
        while (e.hasMoreElements()) {
          target = (org.sf_ref.rdf.implementation.syntax.sirpac.Element)e.nextElement ();
          sTargetAbout = target.about();
          org.sf_ref.rdf.implementation.syntax.sirpac.Element newDescription = new org.sf_ref.rdf.implementation.syntax.sirpac.Element(RDFMS_Description,
                                                new AttributeListImpl ());
    ...
    while (e.hasMoreElements()) {
      org.sf_ref.rdf.implementation.syntax.sirpac.Element n = (org.sf_ref.rdf.implementation.syntax.sirpac.Element)e.nextElement();
   ...
   * @exception SAXException Passed on since we don't handle it.
   */
  private String processPredicate (org.sf_ref.rdf.implementation.syntax.sirpac.Element predicate,
                                   org.sf_ref.rdf.implementation.syntax.sirpac.Element description,
                                   String sTarget,
    ...
    org.sf_ref.rdf.implementation.syntax.sirpac.Element d = new org.sf_ref.rdf.implementation.syntax.sirpac.Element(RDFMS_Description,
                             new AttributeListImpl());
    ...
    while (e2.hasMoreElements()) {
      org.sf_ref.rdf.implementation.syntax.sirpac.Element n2 = (org.sf_ref.rdf.implementation.syntax.sirpac.Element)e2.nextElement();
      ...
      if (isDescription (n2)) {
        org.sf_ref.rdf.implementation.syntax.sirpac.Element d2 = n2;
  ...
  private Statement addOrder(org.sf_ref.rdf.implementation.syntax.sirpac.Element predicate, int orderInt, Statement previousStatement, Resource p, Resource s, RDFNode o) throws SAXException, ModelException {
  ...
  private String processContainer (org.sf_ref.rdf.implementation.syntax.sirpac.Element n) throws SAXException, ModelException {
    ...
    Enumeration e = ((org.sf_ref.rdf.implementation.syntax.sirpac.Element)n).children();
    ...
    int iCounter = 1;
    while (e.hasMoreElements()) {
      org.sf_ref.rdf.implementation.syntax.sirpac.Element n2 = (org.sf_ref.rdf.implementation.syntax.sirpac.Element)e.nextElement();
      if (isListItem (n2)) {
  ...
  private void processListItem (String sID, org.sf_ref.rdf.implementation.syntax.sirpac.Element listitem, int iCounter)
  ...
  String getCompatibilityAttribute(QName bad, QName good, org.sf_ref.rdf.implementation.syntax.sirpac.Element e) {
   ...
   * /@see       registerID
   */
  private void checkAttributes (org.sf_ref.rdf.implementation.syntax.sirpac.Element e) throws SAXException {
   ...
   * @exception SAXException Passed on since we don't handle it.
   */
  private boolean expandAttributes (org.sf_ref.rdf.implementation.syntax.sirpac.Element parent, org.sf_ref.rdf.implementation.syntax.sirpac.Element ele, boolean predicateNode)
    throws SAXException {
	...
	continue;
      ...
      */
      ...
      org.sf_ref.rdf.implementation.syntax.sirpac.Element newElement = new org.sf_ref.rdf.implementation.syntax.sirpac.Element(sAttribute.getNamespace(), sAttribute.getLocalName(),
                                        new AttributeListImpl());
      Data newData = new Data (sValue);
  ...
  */
   ...
   */
  public boolean isDescription (org.sf_ref.rdf.implementation.syntax.sirpac.Element e) {
   ...
   */
  public boolean isListItem (org.sf_ref.rdf.implementation.syntax.sirpac.Element e) {
    return isRDF(e) &&
      ( e.name().endsWith ("li") ||
        e.name().indexOf ("_") > -1);
  }
   ...
   * /@see       isBag
   */
  public boolean isContainer (org.sf_ref.rdf.implementation.syntax.sirpac.Element e) {
    return (isSequence (e) ||
            isAlternative (e) ||
            isBag (e));
  }
   ...
   */
  public boolean isSequence (org.sf_ref.rdf.implementation.syntax.sirpac.Element e) {
   ...
   */
  public boolean isAlternative (org.sf_ref.rdf.implementation.syntax.sirpac.Element e) {
   ...
   */
  public boolean isBag (org.sf_ref.rdf.implementation.syntax.sirpac.Element e) {
   ...
   */
  public boolean isTypedPredicate (org.sf_ref.rdf.implementation.syntax.sirpac.Element e) {
  ...
  public boolean isRDFroot (org.sf_ref.rdf.implementation.syntax.sirpac.Element e) {
   ...
   * URI
   */
  public boolean isRDF (org.sf_ref.rdf.implementation.syntax.sirpac.Element e) {
   ...
   */
  public void resolveLater (org.sf_ref.rdf.implementation.syntax.sirpac.Element e) {
    // SM
    if(!streamMode)
      // END SM
  ...
  public void resolve () throws SAXException {
    ...
    for (int x = 0; x < m_vResolveQueue.size(); x++) {
      org.sf_ref.rdf.implementation.syntax.sirpac.Element e = (org.sf_ref.rdf.implementation.syntax.sirpac.Element)m_vResolveQueue.elementAt(x);
      ...
      if (sAbout != null) {
        ...
        org.sf_ref.rdf.implementation.syntax.sirpac.Element e2 = (org.sf_ref.rdf.implementation.syntax.sirpac.Element)lookforNode(sAbout);
        if (e2 != null) {
          //-> ADDED by PA
          e.resource(e2.ID());
          //-> end ADDED by PA
      ...
      if (sResource != null) {
        ...
        org.sf_ref.rdf.implementation.syntax.sirpac.Element e2 = (org.sf_ref.rdf.implementation.syntax.sirpac.Element)lookforNode(sResource);
        if (e2 != null) {
          //-> ADDED by PA
          e.resource(e2.ID());
          //-> end ADDED by PA
      ...
      String sAboutEach = e.getAttribute (RDFMS_aboutEach);
      if (sAboutEach != null) {
        org.sf_ref.rdf.implementation.syntax.sirpac.Element e2 = (org.sf_ref.rdf.implementation.syntax.sirpac.Element)lookforNode(sAboutEach.substring(1));
        if (e2 != null) {
          //-> ADDED by PA
          e.resource(e2.ID());
          //-> end ADDED by PA
      ...
      if (sAboutEachPrefix != null) {
        for (int y = 0; y < m_vResources.size(); y++) {
          org.sf_ref.rdf.implementation.syntax.sirpac.Element ele = (org.sf_ref.rdf.implementation.syntax.sirpac.Element)m_vResources.elementAt(y);
          String sA = ele.about();
   ...
   */
  public org.sf_ref.rdf.implementation.syntax.sirpac.Element lookforNode (String sID) {
    ...
    if (sID == null) {
      ...
      return (org.sf_ref.rdf.implementation.syntax.sirpac.Element)m_hIDtable.get (source()+/*"#"+*/sID); // ???
    }
  }
   ...
   */
  public void registerID (String sID, org.sf_ref.rdf.implementation.syntax.sirpac.Element e) throws SAXException {
  ...
  public String newReificationID () {
    ...
    String reifStr;
    if(source() != null)
      reifStr = org.sf_ref.rdf.implementation.syntax.sirpac.Element.makeAbsolute( new String ("genid" + m_iReificationCounter), source() );
    else
   ...
   */
  public void registerResource (org.sf_ref.rdf.implementation.syntax.sirpac.Element e) {
    // SM
    if(!streamMode)
      // END SM
  ...
  */
  ...
  static void bailOut() {
    System.err.println("Usage: java -Dorg.xml.sax.parser=<classname> org.sf_ref.rdf.SiRPAC " +
