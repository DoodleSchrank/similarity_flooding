...
public class RDFDigestUtil {
  ...
  public static String modelDigestToURI(Digest d) throws org.sf_ref.rdf.digest.DigestException {

    return "urn:rdf:" + algorithm + "-" + DigestUtil.toHexString(d);
  }

  public static String statementDigestToURI(Digest d) throws org.sf_ref.rdf.digest.DigestException {
   ...
   */
  public static Digest computeStatementDigest(Statement t)  throws org.sf_ref.rdf.digest.DigestException, ModelException {
   ...
   */
  public static Digest computeModelDigest(Model m) throws org.sf_ref.rdf.digest.DigestException, ModelException {
	...
	public int compare(Object o1, Object o2) {
	  ...
	  } catch(org.sf_ref.rdf.digest.DigestException any) {
	  }
    ...
    } catch (org.sf_ref.rdf.digest.DigestException de) { // cannot happen
  ...
  public static Digest getNodeDigest(RDFNode n) throws org.sf_ref.rdf.digest.DigestException, ModelException {

    return n instanceof Digestable ? ((Digestable)n).getDigest() : computeNodeDigest(n);
  }

  public static Digest getStatementDigest(Statement t)  throws org.sf_ref.rdf.digest.DigestException, ModelException {
