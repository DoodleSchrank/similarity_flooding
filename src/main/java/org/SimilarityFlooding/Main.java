...
public class Main {
    private static Pair<Graph, Graph> SimpleExample() {
    ...
    private static Pair<Graph, Graph> ICDE02Example() {
        var nodes = new HashSet<TreeNode>();
    ...
    public static void main(String[] args) {
        ...
        if (g1 == null || g2 == null) throw new RuntimeException("No valid graphs given");
