...
public class HungarianAlgorithm {
    ...
    double[] rowIsCovered, colIsCovered;
    int[] squareInCol, squareInRow, staredZeroesInRow;
    ...
    public HungarianAlgorithm(double[][] matrix) {
        ...
        rowIsCovered = new double[matrix.length];      // indicates whether a row is covered
        colIsCovered = new double[matrix[0].length];   // indicates whether a column is covered
    ...
    public int[][] findOptimalAssignment() {
        ...
        for (var i = 0; i < squareInCol.length; i++) {
